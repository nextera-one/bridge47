...
import { ReportedErrors } from "./reported_errors.entity";

/**
 * Audit entity for tracking changes to the ReportedErrors entity.
 * Each instance of this class represents a single change (INSERT, UPDATE, or DELETE)
 * to a ReportedErrors record.
 */
@AuditEntity(ReportedErrors)
export class ReportedErrorsAudit
  extends ReportedErrors
