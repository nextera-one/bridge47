...
import { AuthTokens } from "./auth_tokens.entity";

/**
 * Audit entity for tracking changes to the AuthTokens entity.
 * Each instance of this class represents a single change (INSERT, UPDATE, or DELETE)
 * to a AuthTokens record.
 */
@AuditEntity(AuthTokens)
export class AuthTokensAudit
  extends AuthTokens
